  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 py-8">
      <div className="lg:col-span-1 rounded-[4px] border border-primary flex flex-col p-4">
        <h3 className="text-xl mb-6 font-bold">{t("RedPandaCommentTitle")}</h3>
        <p className="text-[15px] text-gray-600">
          ...
          <br />
          <br />
          <span className="bg-primary/10">{t("RedPandaComment3")}</span>
          <br />
          <br />
        </p>
        <div className="flex items-center gap-4 mt-4">
          ...
          <div className="flex flex-col">
            <h4 className="text-[14px]">{t("RedPanda")}</h4>
            <p className="text-[11px] text-gray-500">{t("RedPandaIdentity")}</p>
          </div>
        </div>
      </div>
