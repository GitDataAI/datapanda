...
const Brands = () => {
  React.useEffect(() => {
    document.title = "DataPanda | Brands";
  }, []);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-7">
        <div className="sm:col-span-7 md:col-span-7 lg:col-span-6">
          ...
          <div className="flex justify-around mb-6">
            ...
            />
            <Image
              src="/images/logo/datapanda-offline.png"
              alt="Logo 1"
              className="w-28"
            />
            <Image
              src="/images/logo/datapanda-placeholder.png"
              alt="Logo 1"
              className="w-28"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <img
              src="/images/logo/datapanda-white.png"
              alt="Logomark 1"
              className=" object-cover p-4 bg-gray-300"
            />
            <img
              src="/images/logo/datapanda-black.png"
              alt="Logomark 2"
              className=" object-cover p-4 bg-gray-300"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="h-40 bg-gray-200">
              <img
                src="/images/logo/datapanda-black"
                alt="App Icon 2"
                className="w-full h-full object-cover"
              />
            </div>
